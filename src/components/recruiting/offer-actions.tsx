  ...
  return (
    <div className="flex items-center gap-1">
      <Button size="sm" variant="default"
        className="h-7 text-[11px] px-2 bg-slate-700 hover:bg-slate-700 text-white"
      ...
      <Button size="sm" variant="outline"
        className="h-7 text-[11px] px-2 text-slate-700 border-slate-100 hover:bg-slate-50"
      ...
      {error && <span className="text-[11px] text-slate-700 ml-2">{error}</span>}
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="text-sm space-y-3">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1">
                Reason {confirmAction === 'REJECTED' && <span className="text-slate-700">*</span>}
              </label>
              <textarea
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className={confirmAction === 'REJECTED' ? 'bg-slate-700 hover:bg-slate-700 text-white' : ''}
            >
