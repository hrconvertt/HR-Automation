                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        {t.manualReview && <span className="text-[9px] uppercase font-bold text-amber-700 bg-amber-100 px-1.5 py-0.5 rounded">Draft-only</span>}
                        {isUnsaved && <span className="text-[9px] uppercase font-bold text-blue-700 bg-blue-100 px-1.5 py-0.5 rounded">New</span>}
                      </span>
                    </div>
