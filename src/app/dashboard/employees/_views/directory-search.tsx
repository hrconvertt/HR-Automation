                ...
                <div
                  ...
                  className={`bg-white border rounded-xl p-4 transition-all ${
                    isMe
                      ...
                      : 'border-slate-200 hover:border-slate-200 hover:shadow-md'
                  }`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5">
                        ...
                        {isMe && (
                          <span className="text-[10px] font-semibold uppercase tracking-wide px-1.5 py-0.5 rounded bg-slate-50 text-slate-700 border border-slate-100">
                            You
                          </span>
                        )}
                      </div>
                      ...
                      <a
                        ...
                        className="flex items-center gap-1 mt-2 text-[11px] text-slate-700 hover:underline truncate"
                      >
