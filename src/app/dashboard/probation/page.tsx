...
/**
 * Probation — every probation record, not just the live ones.
 *
 * This is the tracker that used to sit as a tab inside Onboarding, which is not
 * where anyone looked for it: there is a Probation item in the sidebar directly
 * beneath Onboarding, and this is now what it opens.
 *
 ...
 * a record was confirmed. This carries the master sheet's tracker columns, with
 * the name opening the full record.
 */
