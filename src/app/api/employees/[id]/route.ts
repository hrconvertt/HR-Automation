...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    const {
      ...
      designation, careerLevel, filerStatus, disbursementMethod,
    ...
    const employee = await prisma.employee.update({
      ...
      data: {
        ...
        emergencyPhone,
        designation,
        careerLevel: careerLevel === '' ? null : careerLevel,
        filerStatus: filerStatus === '' ? null : filerStatus,
        disbursementMethod: disbursementMethod === '' ? null : disbursementMethod,
        departmentId,
        positionId,
